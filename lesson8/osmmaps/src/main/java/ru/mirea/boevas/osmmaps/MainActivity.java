...
import ru.mirea.boevas.osmmaps.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"МИРЭА",
        ...
        marker2.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"МИРЭА - Вернадского",
                        Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        Marker marker3 = new Marker(mapView);
        marker3.setPosition(new GeoPoint(55.7317, 37.5747
        ));
        marker3.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"МИРЭА - Пироговская",
                        Toast.LENGTH_SHORT).show();
                return true;
            }
        });
